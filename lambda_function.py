...
"""
def validate_conditions(age, investment_amount, intent_request):
    if age is not None:
        age = parse_int(age)
        if age < 0 or age > 65:
            return build_validation_result(False, 'age', "Age is not within range of 0 - 64")
    
    if investment_amount is not None:
        investment_amount = parse_int(investment_amount)    
        if investment_amount < 5000:
            return build_validation_result(False, 'investment_amount', "You need to invest a minimum of $5000")    
...
def recommend_portfolio(intent_request):
   # Gets the invocation source, for Lex dialogs "DialogCodeHook" is expected.
    ...
    if source == "DialogCodeHook":
        ...
        validation_result = validate_conditions(age, investment_amount, intent_request)
    ...
    #Performs dialog management and fulfillment for recommending a portfolio.
        ...
        #Prepare investment recommedation
        recommendation = "nan"
            ...
            intent_request["sessionAttributes"],
                ...
                { 
                    ...
                    "content": """Thank you for your information;
                     We recommend that you invest as follows: {}""".format(recommendation)
                }
            )
### Intents Dispatcher ###
def dispatch(intent_request):
    ...
    if intent_name == "reccommendPortfolio":
